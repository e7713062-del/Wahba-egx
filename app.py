...
# 2. تصميم الواجهة (تم حذف اللوجو والإبقاء على النص فقط كما طلبت)
st.markdown("""
    <div style='text-align: left;'>
        <h1 style='margin-bottom: 0; color: var(--text-color); font-family: sans-serif;'>
            WAHBA<span style='color: #0066ff;'>PRO</span>
        </h1>
        <p style='margin-top: 5px; opacity: 0.8;'>OFFICIAL MARKET TERMINAL | EGYPT STOCK EXCHANGE</p>
    </div>
